...
For automation, prefer `--format json` and pass the result to the next tool or notification adapter. Do not assume a specific notification channel unless the user asks for one.

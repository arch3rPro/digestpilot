...
RSS ingest and direct RSS registry commands use the Node/TypeScript RSS runtime. `content fetch` is optional; it enriches archived articles with readable full-text excerpts stored in SQLite and `data/content-cache/`.
